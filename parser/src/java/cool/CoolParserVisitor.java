...
public interface CoolParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CoolParser#attr_list}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAttr_list(CoolParser.Attr_listContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CoolParser#blocked_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBlocked_expr(CoolParser.Blocked_exprContext ctx);
	/**
